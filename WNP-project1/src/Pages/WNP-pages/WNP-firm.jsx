...
import WnpVids from '../../Assets/img/WNPVID/Lady.mp4'
import Work from '../../Assets/img/WNPVID/work.jpg'
import Work1 from '../../Assets/img/WNPVID/work1.jpg'
//import Work1 from '../../Assets/img/WNPVID/testimony'
//import Work1 from '../../Assets/img/WNPVID/testimony1.jpg'
//import Work1 from '../../Assets/img/WNPVID/testimony2.jpg'
import WnpLogo from '../../Assets/img/WNPVID/WnpLogo.png'
...
const DigitalagencyPage = (props) => {
    return (
        <div style={props.style}>
            ...
            <div className="bg-white">
                        ...
                        <Col lg={2} sm={6} xs={"auto"} className="mr-auto ps-0">
                            <Link aria-label="header logo" className="flex items-center" to="/">
                                <Navbar.Brand className="inline-block p-0 m-0">
                                    <img className="default-logo" width="111" height="36" loading="lazy" src={WnpLogo} data-rjs='/assets/img/webp/logo-white@2x.webp' alt='logo' />
                ...
                <div className="full-screen md:h-[600px] sm:h-[350px] md:flex md:items-center overflow-hidden relative bg-white">
                    <div className="absolute top-0 left-0 h-full w-full opacity-30 bg-gradient-to-b from-[transparent] to-[#1f232c]"></div>
                        <Container style={{ zIndex: 11 }} className=" relative md:h-full">
                            <Row className="h-[100vh] md:h-full">
                                <Col className="flex flex-col">
                                    <h1 className="font-serif font-semibold text-white text-[30px] leading-[50px] w-[90%] mt-auto mb-0 tracking-[0px] lg:text-[110px] lg:leading-[100px] md:text-[90px] md:leading-[85px] sm:text-[50px] sm:leading-[50px] sm:-tracking-[.5px] xs:w-[70%] xs:text-[60px] xs:leading-[65px]">We are a small firm specializing in web development brokerage services, leveraging our seasoned expertise and industry experience to deliver tailored solutions to our clients."</h1>
                                    <div className="flex flex-row items-center mt-auto mb-[7.5rem]">
                                        ...
                                        <span className="font-serif text-lg text-[#e6994e] xs:text-xmd">Innovative Startup</span>
                                    </div>
                                </Col>
                            </Row>
                        </Container>
                ...
                {/*Section start needs work or cut out */}
                    ...
                    <Container>
                        <Row className="items-center justify-center">
                            <Col xl={5} md={6} xs={11} className="sm:mb-[30px]">
                                <m.h2  {...{ ...fadeIn, transition: { delay: 0.2 } }} className="heading-4 font-serif font-semibold text-darkgray mb-0">Is WNP a right fit for you?</m.h2>
                            </Col>
                            <Col xl={{ span: 5, offset: 1 }} md={6} xs={11}>
                                <m.p  {...{ ...fadeIn, transition: { delay: 0.3 } }} className="text-lg mb-[25px] leading-[38px] md:text-xmd">Look below </m.p>
                ...
                <InViewPort>
                    ...
                    <m.section className="overflow-visible p-0 relative" {...fadeIn}>
                        <Container fluid>
                            <Row>
                                ...
                                <Col xl={7} lg={6} className="cover-background md:h-[500px] sm:h-[350px]" style={{ backgroundImage: `url(${Work1})` }}></Col>
                                <Col xl={5} lg={6} className="bg-darkgray py-40 px-[9%] xl:p-[6%] lg:p-[6%] md:p-[10%] sm:py-[15%] sm:px-[10%]">
                                    ...
                                    <m.h2 {...{ ...fadeIn, transition: { delay: 0.4 } }} className="heading-4 font-serif font-semibold text-white -tracking-[.5px] mb-12 w-[90%] sm:w-full">Need a website for your buisness?</m.h2>
                                    <m.p {...{ ...fadeIn, transition: { delay: 0.6 } }} className="text-lg leading-[38px] mb-[42px] w-[90%] lg:w-full md:w-[80%] sm:w-full md:text-xmd">We acts as an intermediary between clients who need web development services and developers or agencies who provide those services</m.p>
                                    <m.div {...{ ...fadeIn, transition: { delay: 0.8 } }}><Buttons ariaLabel="link for conatct modern page" to='/page/about-us' className="font-medium font-serif uppercase btn-link after:h-[2px] md:text-md md:mb-[15px] after:bg-white hover:text-white tracking-[1px]" size="xl" color="#fff" title="Click here to learn more " /></m.div>
                                </Col>
                            </Row>
                        </Container>
                    </m.section>
                    {/* Section End */}
                     ...
                     {/*I duplacter the section above need to add a break in between the 2 */}
                    ...
                    <m.section className="overflow-visible p-0 relative" {...fadeIn}>
                        <Container fluid>
                            <Row>
                                ...
                                <Col xl={7} lg={6} className="cover-background md:h-[500px] sm:h-[350px]" style={{ backgroundImage: `url(${Work})` }}></Col>
                                <Col xl={5} lg={6} className="bg-darkgray py-40 px-[9%] xl:p-[6%] lg:p-[6%] md:p-[10%] sm:py-[15%] sm:px-[10%]">
                                    <m.span {...fadeIn} className="font-serif font-medium text-[#e6994e] tracking-[2px] uppercase block mb-[35px]">Let's work together</m.span>
                                    <m.h2 {...{ ...fadeIn, transition: { delay: 0.4 } }} className="heading-4 font-serif font-semibold text-white -tracking-[.5px] mb-12 w-[90%] sm:w-full">Looking for work?</m.h2>
                                    <m.p {...{ ...fadeIn, transition: { delay: 0.6 } }} className="text-lg leading-[38px] mb-[42px] w-[90%] lg:w-full md:w-[80%] sm:w-full md:text-xmd">Are you a talented web developer looking to take your skills to the next level? Do you want to focus on what you do best—building amazing websites and applications—while leaving the rest to experts? Welcome to WNP Brokerage , where we're committed to helping developers like you thrive in the digital world. </m.p>
                                    <m.div {...{ ...fadeIn, transition: { delay: 0.8 } }}><Buttons ariaLabel="link for conatct modern page" to='/page/about-me' className="font-medium font-serif uppercase btn-link after:h-[2px] md:text-md md:mb-[15px] after:bg-white hover:text-white tracking-[1px]" size="xl" color="#fff" title="Click here to learn more " /></m.div>
                                </Col>
                            </Row>
                        </Container>
                    </m.section>
                        ...
                        <Container>
                            <Row sm={2} xs={1} className="items-center">
                                <Col className="text-left xs:mb-[10px]">
                                    <h2 className="heading-4 xs:text-center font-serif font-semibold text-darkgray mb-0">Testimony</h2>
                                </Col>
            ...
            {/* Footer Start */}
            <FooterStyle12 className="footer-digitalagency text-[#828282] bg-white" theme="light" logo={WnpLogo} />
            {/* Footer End */}
        </div>
    )
}
