...
//vids wont & img EX:`url(${Work1})`
import WnpFlHeader from '../../Assets/img/WNPVID/Header3.mp4'
...
const IconWithTextData = [
  {
    ...
    title: "Falling into alignment",
    content: "Seamlessly integrating all elements of the website or everything falling into place smoothly.",
  },
  {
    icon: "line-icon-Archery-2 text-fastblue text-[40px]",
    title: "Target Audience",
    content: "designing and developing the website with the needs, preferences, and behaviors of the target audience as the primary consideration.",
  },
  {
    icon: "line-icon-Knight text-fastblue text-[40px]",
    title: "Content Strategy",
    content: "A strategic website builder must prioritize creating top-notch, relevant content that educates, informs, and inspires users. This content drives conversions and helps achieve business goals.",
  },
]
...
<section className="p-0 bg-cover bg-center relative">
      <video autoPlay loop muted className="absolute inset-0 w-full h-full object-cover">
        <source src={WnpFlHeader} type="video/mp4" />
      ...
      <Container className="relative h-[800px] md:h-[600px] sm:h-[400px]">
        <Row className="items-center h-full md:pb-40 sm:pb-0">
          <Col lg={{ span: 6, offset: 6 }} sm={{ span: 7, offset: 5 }}>
            <h2 className="font-serif text-white -tracking-[1px] mb-[40px] xs:mb-[25px] font-medium xs:text-center"><span className="text-decoration-line-bottom-thick">Looking for work</span></h2>
            <p className="w-3/4 md:w-full xs:w-4/5 font-serif text-white leading-[30px] opacity-70 font-light text-xmd mb-10 block xs:mx-auto xs:text-center">Are you a talented web developer looking to take your skills to the next level? Do you want to focus on what you do best—building amazing websites and applications—while leaving the rest to experts? Welcome to WNP Brokerage, where we're committed to helping developers like you thrive in the digital world. </p>
        ...
        <Container>
          <Row className="items-center">
            <Col lg={{ span: 4, offset: 1 }} className="md:mb-20">
              ...
              <p>Joining WNP Brokerage opens doors to a wide range of exciting projects spanning various industries, technologies, and complexities. </p>
              <br></br>
              <p>Whether you're passionate about e-commerce, SaaS, mobile apps, or custom solutions, we'll connect you with projects that align with your interests and expertise.</p>
            </Col>
  ...
  <Container>
    <Row className="items-center">
      ...
      <Col lg={{ span: 4, offset: 1 }} className="md:mb-20">
        ...
        <p>We understand that every developer has unique preferences and constraints when it comes to work arrangements. </p>
        <br></br>
        <p>With WNP Brokerage, you have the flexibility to choose projects that fit your schedule, workload, and preferred working environment—whether it's full-time, part-time, freelance, or remote. </p>
      </Col>
    </Row>
  </Container>
</m.section>
        ...
        <Container>
          <Row className="items-center">
            <Col lg={{ span: 4, offset: 1 }} className="md:mb-20">
              ...
              <p>We take care of the administrative hassle so you can focus on what you do best: coding. </p>
              <br></br>
              <p>Our streamlined onboarding process ensures a smooth transition onto new projects, while our dedicated support team is always available to assist you with any questions or issues that arise.</p>
            </Col>
            <Col lg={{ span: 5, offset: 1 }} className="mb-[30px]">
              <ProgressBar
                theme="progressbar-style-01 about-me-progressbar"
  ...
  <Container>
    <Row className="items-center">
      ...
      <Col lg={{ span: 4, offset: 1 }} className="md:mb-20">
        ...
        <p>Your talent and hard work deserve to be rewarded fairly. With WNP Brokerage, you can expect competitive compensation and incentives commensurate with your skills and contributions </p>
        <br></br>
        <p>    We believe in fostering a culture of appreciation and recognition, where your achievements are celebrated and your efforts are valued. </p>
      </Col>
    </Row>
  </Container>
</m.section>
{/* Section End */}
      ...
      {/* Section Start freelancer testomonis*/}
            ...
            <Col lg={7} xl={{ span: 6, offset: 1 }} className="text-center md:text-start">
              <Row>
                <Col md={{ span: 9, offset: 3 }} >
                  <h5 className="font-serif mb-12 font-medium text-darkgray lg:text-start sm:text-center xs:w-full xs:m-[0_auto] xs:mb-12"><span className="font-semibold  underline underline-offset-8">Testimony</span></h5>
                </Col>
              </Row>
              <Row className="text-right">
                <Col md={3} className="font-serif text-darkgray sm:text-center xs:mb-[5px]">John Smith:</Col>
                <Col md={9} className="mb-[2.5rem] text-left sm:text-center">"Working with WNP Brokerage has been an absolute pleasure. Their team's expertise and dedication ensured that our website was not only visually stunning but also functional and user-friendly. From start to finish, they listened to our needs and provided tailored solutions that exceeded our expectations. I highly recommend WNP Brokerage to anyone looking to elevate their online presence."
                  <div className="w-full h-[1px] bg-darkgray mt-[2.5rem] opacity-10"></div>
                </Col>
                <Col md={3} className="font-serif text-darkgray sm:text-center xs:mb-[5px]">Emily Johnson:</Col>
                <Col md={9} className=" mb-[2.5rem] text-left sm:text-center">"As a small business owner, partnering with WNP Brokerage was one of the best decisions I made. Their attention to detail and commitment to delivering results were evident throughout the website development process. They took the time to understand my brand and objectives, resulting in a website that perfectly represents my business. I'm thrilled with the outcome and grateful for their expertise."
                  <div className="w-full h-[1px] bg-darkgray mt-[2.5rem] opacity-10"></div>

                </Col>
                <Col md={3} className="font-serif text-darkgray sm:text-center xs:mb-[5px]">Steve Williams:</Col>
                <Col md={9} className="text-left sm:text-center">"I cannot speak highly enough of the team at WNP Brokerage. From the initial consultation to the final launch, they demonstrated professionalism and proficiency at every step. Their communication was excellent, keeping me informed and involved throughout the project. The end result exceeded my expectations, and I am delighted with the website they created for my business. WNP Brokerage truly sets the standard for web development services."</Col>
              </Row>
            </Col>
          </Row>
        </Container>
        ...
        <Container>
          <Row className="justify-center">
            <Col className="text-center" md={7} lg={6} xs={12}>
              <span className="text-basecolor text-lg mb-[15px] md:text-xmd inline-block">Lets to work together</span>
              <h5 className="font-serif font-medium -tracking-[0.5px] text-darkgray inline-block mb-[60px] sm:mb-[30px]">Ready to Elevate Your Freelance Career to New Heights?</h5>
            </Col>
          </Row>
          <Row className="justify-center">
                ...
                {({ isSubmitting, status }) => (
                  <div className="relative subscribe-style-02 w-4/5 md:w-full">
                    <Form className="relative">
                      ...
                      <button type="submit" className={`text-xs tracking-[1px] py-[12px] px-[28px] uppercase${isSubmitting ? " loading" : ""}`}>Work with us</button>
                    </Form>
                    <AnimatePresence>
